...
class DataLayer():
    ...
    def load_trained_model(self):
        ...
        try:
            ...
            logging.info("Failed to load the dynamic model! Fallback to static model.")
        try:
            return pickle.load(open(Params.PATH_TO_STATIC_MODEL, 'rb'))
        except Exception as e:
            logging.fatal("Failed to load the static model! "+e)
            exit()
    ...
    def store_model(self, model):
        try:
            ...
            logging.info("Retrained model stored")
        except Exception as e:
